...
# Both distribution seem to be approximating a normal distribution. The Male histogram seems a better fit.
...
**Seems like the data follows a nearly normal distribution**
...
**This plot is similar to the real data plot.**
...
**Even though there are outliers, the female heights seem to be normally distributed.** 
...
**The Female weight does not appear to be a normal distribution.We can see that the data points do not fit the line well and give a curve. Also, there are a lot of outliers towards the upper end.**
...
**Q1: What is the probability that a randomly choosen female is taller than 153?**
...
**Q1: What is the probability that a randomly choosen female weighs less  than 72KG?
...
**The weight has a closer agreement than the heights**
...
**This may seem to indicate that the data is not exactly continuous but rather increments in step wise numbers.**
...
**The normal probability plot indicates that the knee diameter is right skewed.The histogram also agrees with the finding**
