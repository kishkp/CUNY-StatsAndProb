...
![rinterface](https://raw.githubusercontent.com/kishkp/CUNY-StatsAndProb/master/Lab0/more/rInterface2014.png)
...
source("https://raw.githubusercontent.com/kishkp/CUNY-StatsAndProb/master/Lab0/more/arbuthnot.R")
```
...
source("https://raw.githubusercontent.com/kishkp/CUNY-StatsAndProb/master/Lab0/more/present.R")
```
...
**We can see that the birth counts for both boys and girls in the "Present" dataset is quite high compared to the "Arbuthnot" dataset. The "Arbuthnot" baptism data are in thousands whereas in "present" birth counts data are in the million range.**
...
**From the plot we can see that the boys are born in greater proportion even in the "present" dataset. However, the trend is decreasing. The recent years are seeing a more balanced birth.**
...
present[order(present[,2] + present[,3],decreasing = TRUE)[1],1]

```
**source : http://stackoverflow.com/questions/743622/finding-row-index-containing-maximum-value-using-r**
