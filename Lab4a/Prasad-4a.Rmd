...
**The Histogram indicates that the distribution is slightly right skewed.**
...
**The Histogram indicates that the distribution is again slightly right skewed.**
...
**We find that the mean of samp2 is not the same as samp1**

**In some instances, a particular sample with lesser size may yield a more accurate representation of the population mean than a sample with more size. However, in general, a larger sample size yields a more accurate estimate of the population mean**    
...
**The sampling distribution seems to be normal with a mean of `r mymean`**

**I would not expect the distribution with 50,000 sample means to change much except that it will be more normal than with 5000 elements**
...
**sample_means_small has 100 elements**
**Each element respresents the mean of a sample of 50 house areas**
...
**As the sample size increases, we find that the center is more nearer to the population mean. As the sample size gets larger, we find that the spread of the distribution gets smaller** 
...
**The point estimate for the population mean with the above sample was `r mymean`** 
...
**The shape of the distribution looks to be normal but spread out.**
**The visual indication of the mean home price is around 180,000**
**The mean of the sampling distribution is `r mean(sample_means50)`**
**The population mean is `r mean(price)`**
...
**The shape of the distribution looks to be normal but less spread out than the sample_means50 data**
**The visual indication of the mean home price is slightly above 180,000**
**The mean of the sampling distribution is `r mean(sample_means150)`**
...
**The sampling distribution with size 150 has a smaller spread than the one with 50.**
**If we have to be more accurate in our estimates, a smaller spread will have a better chance**
