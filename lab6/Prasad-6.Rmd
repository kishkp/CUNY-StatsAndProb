...
**The statistics presented are sample statistics.**
...
**The sampling method must be unbiased and should reflect the composition of the population. Countries with larger population should have larger number of respondents.** 
...
**Each row of Table 6 corresponds to a country, sample size and response breakup to the survey question in the year 2012**

**Each row of atheism corresponds to a country, the survey year and response.**
...
**The percentage in the above calculation when rounded off gives 5% which is same as in table 6.**
...
**1.The sample observations must be independent - There are `r nrow(us12)` observations in the US dataset. This count is less than 10% of the US population. Hence we can conclude that the condition for independence is met by the dataset**

**2. There are at least 10 success and 10 failures -  There are `r nrow(us12[us12$response=="atheist",])` atheists and `r nrow(us12) - nrow(us12[us12$response=="atheist",])` non-atheists. Hence this condition is also met.**
...
**The margin of error is: `r (0.0634 - 0.0364) / 2`**
...
**Lets calculate the confidence intervals for Japan and Sweden**

**First we create the datasets and we check the conditons for inference for both countries.**  
...
**There are `r nrow(japan12)` observations in the Japan dataset. This count is less than 10% of the population. Hence we can conclude that the condition for independence is met by the Japan dataset.**

**Similarly, there are `r nrow(sweden12)` observations in the Sweden dataset. This count is less than 10% of the population. Hence we can conclude that the condition for independence is met by the Sweden dataset.**

**2. There are at least 10 success and 10 failures**

**There are `r nrow(japan12[japan12$response=="atheist",])` atheists and `r nrow(japan12) - nrow(japan12[japan12$response=="atheist",])` non-atheists. Hence this condition is also met for the Japan dataset.**

**Similarly, there are `r nrow(sweden12[sweden12$response=="atheist",])` atheists and `r nrow(sweden12) - nrow(sweden12[sweden12$response=="atheist",])` non-atheists. Hence this condition is also met for the Sweden dataset.**

**The confidence interval for Japan is:**
...
**The confidence interval for Sweden is:**
...
**The margin of error is the highest when the proportion is at 50%. It tapers down from this high on either sides until the margin of error is the lowest when the proportion is 0 (or 100 on the other end)**  
...
**The distribution is centered around `r round(p_hats_summ["Mean"],2)`. It has a spread of `r round(p_hats_summ["Max."] - p_hats_summ["Min."],2)`, is unimodel and is normally shaped
...
**As n increases, we find that the spread of the distribution decreases.**
**A change in p shifts the center of the distribution around that particular value of p**
...
** The margin of errors are 1.8% and 1.4% respectively for Australia and Ecuador respectively. These are well below the ME estimates of the study at 3-4%. Though the study ME seems inaccurate, a higher margin of error would mean that there is a better chance for the population parameter is within the estimates.**
...
**H~0~: There is no difference in means between atheism index from 2005 to 2012**

**H~A~: There is a difference in means between atheism index from 2005 to 2012**
...
```
**Checking for the conditions of inference:**

**1.The sample observations must be independent**

**There are `r nrow(sp_2005)` observations in the 2005 dataset and `r nrow(sp_2012)` observations in the 2012 dataset. These counts are less than 10% of the population. Hence we can conclude that the condition for independence is met by the datasets.**

**2. There are at least 10 success and 10 failures**

**There are `r nrow(sp_2005[sp_2005$response=="atheist",])` atheists and `r nrow(sp_2005) - nrow(sp_2005[sp_2005$response=="atheist",])` non-atheists in 2005 dataset and `r nrow(sp_2012[sp_2012$response=="atheist",])` atheists and `r nrow(sp_2012) - nrow(sp_2012[sp_2012$response=="atheist",])` non-atheists in 2012 dataset. Hence this condition is also met for both datasets.**

**The inference for both datasets is:**
...
**Since there is a significant overlap of the confidence intervals. We can conclude that no difference in means between atheism index from 2005 to 2012**
...
**Since there is no overlap of the confidence intervals. We can conclude that there is a difference in means between atheism index from 2005 to 2012**
...
**If there is no change in the atheism index, We  would expect to detect a change 5% of the time simply by chance.**
...
**Assuming at the worst case of the proportion being at 50%.**
...
**The requisite number of samples would be: 9604**
