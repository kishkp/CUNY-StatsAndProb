...
**Even though the statistics presented are derived from the sample, the paragraph attemps to generalize the findings to the population on the whole. This attempt would qualify the percentages as population parameters inferred from the sample statistics**
